...
import { ReactComponent as PerspnOutlineIcon } from "../assets/svg/personOutlineIcon.svg";
import { ReactComponent as RandmoSvg } from "../assets/svg/bedIcon.svg";
            ...
            <nav className="navbarNav">
                <ul className="navbarListItems">
                    ...
                    <li className="navbarListItem" onClick={() => navigate('/profile')}>
                        <PerspnOutlineIcon fill={pathMatchRoute('/profile') ? '#2c2c2c' : '#8f8f8f'} width='36px' height='36px' />
